...
template Pose6D set_pose6d<float>(const double t, const Matrix<float, 3, 1> &a, const Matrix<float, 3, 1> &g, const Matrix<float, 3, 1> &v, const Matrix<float, 3, 1> &p, const Matrix<float, 3, 3> &R);
template Pose6D set_pose6d<double>(const double t, const Matrix<double, 3, 1> &a, const Matrix<double, 3, 1> &g, const Matrix<double, 3, 1> &v, const Matrix<double, 3, 1> &p, const Matrix<double, 3, 3> &R);
...
template bool esti_plane<float>(Matrix<float, 4, 1> &, const PointVector &, const float &);
template bool esti_plane<double>(Matrix<double, 4, 1> &, const PointVector &, const double &);
